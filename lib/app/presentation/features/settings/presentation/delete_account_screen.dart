...
import 'package:max_4_u/app/presentation/features/settings/presentation/confirm_delete_account_password_screen.dart';
...
class _DeleteAccountScreenState extends State<DeleteAccountScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ButtonWidget(
                        ...
                        color: Colors.red,
                        onTap: () {
                          deleteAccountDialog(context, deleteAcct);
                        },
                      )
                    ],
                  ),
  ...
  Future<dynamic> deleteAccountDialog(
      BuildContext context, DeleteAccountProvider deleteAcct) {
    return showDialog(
        context: context,
        builder: (context) {
