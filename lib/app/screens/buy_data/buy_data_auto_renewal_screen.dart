...
import 'package:max_4_u/app/screens/buy_data/buy_data_autorenewal_confirmation_screen.dart';
...
import 'package:max_4_u/app/widgets/validity_date_widget.dart';
import 'package:provider/provider.dart';

class BuyDataAutoRenewalScreen extends StatefulWidget {
  const BuyDataAutoRenewalScreen(
      {super.key,
  ...
  @override
  State<BuyDataAutoRenewalScreen> createState() =>
      _BuyDataAutoRenewalScreenState();
}

class _BuyDataAutoRenewalScreenState extends State<BuyDataAutoRenewalScreen> {
  DateTime? _startDate;
  DateTime? _endDate;
