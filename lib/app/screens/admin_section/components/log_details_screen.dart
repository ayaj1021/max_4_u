...
class LogDetailsScreen extends StatelessWidget {
  const LogDetailsScreen(
      {super.key, required this.firstName, required this.lastName, required this.index});
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    verticalSpace(20),
                    LogDetailsSection(title: 'Device', value:  '${data.deviceName ?? ''}',),
                    LogDetailsSection(title: 'Operating System', value:  '${data.operatingSystem ?? ''}',),
                    LogDetailsSection(title: 'IP Address', value:  '${data.ipAddress ?? ''}',),
                    verticalSpace(52),
                    Container(
                      height: 486.h,
