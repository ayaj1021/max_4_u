...
class AppTextStyles {
  static TextStyle font14 = TextStyle(fontSize: 14.sp, fontFamily: 'Poppins');
  static TextStyle font20 = TextStyle(
      fontSize: 20.sp, fontWeight: FontWeight.w700, fontFamily: 'Poppins');
  static TextStyle font16 = TextStyle(
      fontSize: 16.sp, fontWeight: FontWeight.w700, fontFamily: 'Poppins');
  ...
  static TextStyle font10 = TextStyle(
      fontSize: 10.sp, fontWeight: FontWeight.w700, fontFamily: 'Poppins');
}
